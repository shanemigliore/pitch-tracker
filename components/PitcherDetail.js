...
// ══════════════════════════════════════════════════════════════════════════════
function PitcherDetail({ pitcher, onBack, tournaments, onEditGame, onDeleteGame, onEditPlayer }) {
    ...
    <div style={{ padding:"0 16px 110px" }}>
      ...
      {editOpen && (
        <div style={{ ...card, border:"1px solid rgba(56,189,248,0.25)", marginBottom:12 }}>
          ...
          <input placeholder="e.g. 07 (optional)" value={editJersey} aria-label="Jersey number" inputMode="numeric"

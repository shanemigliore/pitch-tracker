...
// ─── Shared styles ────────────────────────────────────────────────────────────
const inputStyle = {
  display:"block", width:"100%", maxWidth:"100%", padding:"10px 13px", borderRadius:10, fontSize:14,
...
window.UIConstants = { STATUS, I, inputStyle, primaryBtn, cancelBtn, card, sectionLabel };
